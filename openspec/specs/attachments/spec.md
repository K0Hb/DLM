...
Admin/superadmin MUST attach photos on the work-order card. The assignee (or admin) MUST attach photos on their line from the cabinet/line UI. In UI, clicking a thumbnail MUST open a preview; download and delete MUST be separate links/actions.
...
#### Scenario: Preview vs download
- **WHEN** a user clicks a photo thumbnail
- **THEN** a preview opens; download and delete remain available as separate controls
